...
[![Build Status](https://travis-ci.org/armor/armor-gulp-plugins.svg?branch=master)](https://travis-ci.org/armor/armor-gulp-plugins)
...
- main: add `// transpile:main` at the beginning of the file ([example here](https://github.com/armor/armor-gulp-plugins/blob/master/test/fixtures/es7/lib/run.es7.js)) .
- mocha: add `// transpile:mocha` at the beginning of the file ([example here](https://github.com/armor/armor-gulp-plugins/blob/master/test/fixtures/es7/test/a-specs.es7.js))
...
Since this package is used to build and test all the Armor packages, it should
